...
e){for(var d=$jscomp.makeIterator(a),g=d.next();!g.done;g=d.next())c(g.value).callWhenSettled_(b,e)})};d.all=function(a){var b=$jscomp.makeIterator(a),e=b.next();return e.done?c([]):new d(function(a,d){function g(b){return function(c){f[b]=c;h--;0==h&&a(f)}}var f=[],h=0;do f.push(void 0),h++,c(e.value).callWhenSettled_(g(f.length-1),d),e=b.next();while(!e.done)})};return d},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";
...
var puppeteer=require("puppeteer"),nodemailer=require("nodemailer"),transporter=nodemailer.createTransport({service:"gmail",auth:{user:"fakekateharris@gmail.com",pass:"kateharris123"}}),sendEmail=function(a){transporter.sendMail({from:"fakekateharris@gmail.com",to:"ylq.7719@gmail.com, wenfengqiu@hotmail.com",subject:"NBA TOP SHOT!!!",text:a},function(a,c){a&&console.log(a)})};
function webScraper(){var a,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){switch(c.nextAddress){case 1:return c.yield(puppeteer.launch(),2);case 2:return a=c.yieldResult,c.yield(a.newPage(),3);case 3:return b=c.yieldResult,c.yield(b.goto("https://nbatopshot.com/packs"),4);case 4:return b.on("console",function(a){a=a.text();a.includes("Release 23")&&sendEmail(a);setTimeout(function(){webScraper()},18E5)}),c.yield(b.evaluate(function(){var a=document.body.querySelectorAll('[class^="NextDrop__StyledDescription"]')[0];
console.log(a.outerText)}),5);case 5:return c.yield(a.close(),0)}})}webScraper();